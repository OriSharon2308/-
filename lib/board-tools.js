...
const BOARD_TOOLS = [
  ...
  {
    name: "resize_item",
    description: "משנה גודל של ווידג'ט (w,h) או של תרגיל (scale) קיים לפי id — לאיזון פרופורציות על הלוח.",
    input_schema: {
      type: "object",
      properties: {
        id: { type: "string", description: "מזהה הפריט" },
        w: { type: "number", description: "רוחב חדש (לווידג'ט, 140–880)" },
        h: { type: "number", description: "גובה חדש (לווידג'ט, 90–660)" },
        scale: { type: "number", description: "קנה-מידה (לתרגיל, 0.5–3)" },
      },
      required: ["id"],
    },
  },
