...
const CURRICULUM = {
  1: {
    ...
    topics: [
      ...
      { key: "שאלות חשיבה", gen: "thinking", levels: [1, 2], params: { max: 20 } },
    ],
  },
  2: {
    grade: "ב׳",
    ...
    topics: [
      ...
      { key: "שאלות חשיבה", gen: "thinking", levels: [1, 2, 3], params: { max: 100 } },
    ],
  },
  3: {
    grade: "ג׳",
    ...
    topics: [
      ...
      { key: "שאלות חשיבה", gen: "thinking", levels: [2, 3, 4], params: { max: 1000 } },
      { key: "בעיות רב-סעיפיות", gen: "multiStep", levels: [1, 2], params: { max: 1000 } },
    ],
  },
  4: {
    grade: "ד׳",
    ...
    topics: [
      ...
      { key: "שאלות חשיבה", gen: "thinking", levels: [2, 3, 4, 5], params: { max: 1000 } },
      { key: "בעיות רב-סעיפיות", gen: "multiStep", levels: [1, 2, 3], params: { max: 1000 } },
    ],
  },
  5: {
    grade: "ה׳",
    ...
    topics: [
      ...
      { key: "שאלות חשיבה", gen: "thinking", levels: [3, 4, 5], params: { max: 1000 } },
      { key: "בעיות רב-סעיפיות", gen: "multiStep", levels: [2, 3, 4], params: { max: 1000 } },
    ],
  },
  6: {
    grade: "ו׳",
