...
function buildSystem({ gender, profileText, topic }) {
  ...
  const lines = [
    ...
    "טיפים: למשולש/ריבוע השתמש/י ב-draw_polygon; לציר מספרים ב-draw_number_line; לסימון נקודה ב-draw_point; להצבעה ב-draw_arrow. לשעון: עיגול + write_text למספרים + draw_line למחוגים מהמרכז.",
  ];
