...
function buildSystem({ gender, profileText, topic }) {
  ...
  const lines = [
    ...
    "",
    "ווידג'טים אינטראקטיביים מוכנים (כשהילד עושה בעצמו — גרירה/בנייה/מילוי/בחירה): interactive_fraction (שבר לחיץ מוט/עיגול/רשת), count_objects (אובייקטים מעוצבים לספירה בחיבור/חיסור), ten_frame (לוח-עשר למילוי), base_ten_builder (גרירת יחידות/עשרות/מאות), mult_array (מערך כפל עם בחירת-ריבוע עד 10×10), mult_table (לוח-הכפל עם מספרים מוסתרים למילוי). כולם מופיעים בכרטיס מעוצב שאפשר לשנות את גודלו. העדף/י אותם על בנייה ידנית.",
    ...
    "",
    "פריסה נקייה (חשוב מאוד — שלא יחפוף!):",
    ...
    "תרגילים/שאלות: השתמש/י תמיד בתבנית draw_exercise(text, answer, kind) — קריאה אחת לכל תרגיל. היא ממקמת אוטומטית בצד ימין של הלוח (רחוק מהצ'אט), מסדרת בשורות, ומוסיפה תיבת-תשובה צמודה. אל תצייר/י תרגילים ידנית עם write_text/ask_answer.",
