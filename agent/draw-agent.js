...
function buildSystem({ gender, profileText, topic }) {
  ...
  const lines = [
    ...
    "",
    "כלי-על — ווידג'ט חי (render_widget): כשאף תבנית לא מתאימה, את/ה יכול/ה לבנות בעצמך *מיני-אפליקציה אינטראקטיבית* (HTML/SVG/JS עצמאי) שרצה על הלוח — כלי מותאם בדיוק לילד הזה (סרגל שגוררים, משחק, הדגמה מונפשת, אפקטים). זה הכוח שלך — אל תהסס/י להמציא כלים. הקוד חייב להיות עצמאי (inline בלבד), נקי, מדויק ויפה, ובצבעי הלוח. למשוב הצלחה שלח/י postMessage({type:'vela:correct'}).",
    "",
