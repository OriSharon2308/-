...
// וֶלָה · תוכנית הבנייה — שתי תוכניות: וֶלָה (מבצעית) והמיליון (קומות ההון).
...
(function () {
  ...
  const VELA = {
    ...
    chapters: [
      ...
      },
      {
        ...
        compare: {
          head: ["", "וֶלָה", "Brilliant", "Matific/אחרים"],
          rows: [
      ...
      },
      {
        ...
        why: "מורה פרטי בישראל עולה ₪120–200 לשיעור בודד. וֶלָה נותנת מורה זמין כל יום. המחיר צריך לשדר 'חלופה רצינית למורה פרטי במחיר של שיעור אחד בחודש' — לא 'עוד אפליקציה ב-₪20'.",
      ...
      },
      {
        ...
        advice: "מסלול הפרסום: (שלב א) תיעוד אמיתי — אמא מצלמת את הילד מדבר עם וֶלָה, אתה מפרסם בקבוצות הורים. (שלב ב) עמוד טיקטוק/אינסטגרם עם קטעי 'הילד שואל — וֶלָה עונה' — הקול הוא הכוכב. (שלב ג) קמפיין מטא ממוקד אמהות 28–45 בישראל, תקציב ניסיון ₪1,500, על 3 גרסאות של וידאו-הדמו. (שלב ד) שת\"פ מורים פרטיים ומורות-אם משפיעניות — 20% עמלה. יצירת הפרסומות: אני כותב תסריטים, אתה מצלם בטלפון — אותנטי מנצח מלוטש אצל הורים.",
        goals: [
          { id: "v5.1", t: "לכתוב 5 תסריטי וידאו קצרים (הוק → בעיה → וֶלָה עונה בקול → תוצאה)", n: "אני אכתוב איתך — תבקש." },
      ...
      },
      {
        ...
        advice: "הלולאה של וֶלָה: הקול מייצר רגע-וואו ← רגע-הוואו מצולם ומופץ (הורים משתפים ילד שלומד בשמחה) ← ההפצה מביאה ניסיון חינם עם 'בדיקת רמה ב-3 דקות' ← הדוח להורה מוכיח ערך כל שבוע ← ההורה מספר בקבוצה ← חוזר להתחלה. כל פרק בתוכנית הזו מחזק חוליה אחת בלולאה. המדד האחד שקובע: כמה הורים הביאו הורה אחר החודש.",
        goals: [
  ...
  const MILLION = {
    hero: {
      ...
      sub: "כל קומה היא מדרגת כסף עם שער מספרי בסופה. המנוע: וֶלָה. המשמר: שוק ההון. לחץ על קומה כדי להיכנס לתוכנית העבודה שלה.",
      stats: [
    ...
    floors: [
      ...
      },
      {
        ...
        time: "שנים 3–4",
        why: "כאן מתממשת ההכרעה מתוכנית וֶלָה: גלובלי (אנגלית) או עומק (משרד החינוך). $1M ARR = בערך ₪310K MRR — פי 3 מקומה 2. זה לא קורה מאותם ערוצים — זה קורה משוק חדש.",
      ...
      },
      {
        ...
        time: "חודשים 4–12",
        why: "זה היעד מהמסמך שלך — ₪30K MRR = בערך 450 מנויים בממוצע ₪69. כאן וֶלָה הופכת מ'פרויקט מבטיח' ל'עסק אמיתי שמפרנס'. כל תוכנית וֶלָה המבצעית חיה בתוך הקומה הזו.",
      ...
      },
      {
        ...
        advice: "זו הקומה שבה נמצאת כרגע כל תוכנית וֶלָה (הטאב השני למעלה) — האימות, 10 המשלמים, המחיר המוקדם. אל תנסה לדלג: מי שמדלג על קומה 0 בונה בניין באוויר. שלושה חודשים של אמת שחוסכים שנה של דשדוש.",
        numbers: [
          { v: "10", k: "משלמים" },
  ...
  function renderVela() {
    ...
    main.innerHTML = `
      ...
      <div class="chapters">${chapters}
        <p class="smallnote">תוכנית וֶלָה היא קומות 0–1 של תוכנית המיליון: כשנפתח שער ₪30K — עוברים לטאב השני וממשיכים לטפס.</p>
      </div>`;
    wire();
  }
